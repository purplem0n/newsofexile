/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: c61d4ff3142d00607dff3215aa3ea903)
...
declare namespace Cloudflare {
	...
	interface Env {
		...
		TWITCH_SENDER_ID: string;
		TWITCH_DRY_RUN_CHANNEL_ID: string;
		DRY_RUN_MODE: string;
		POE1_TWITCH_ID: string;
		POE2_TWITCH_ID: string;
	}
}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "DATABASE_URL" | "POE_COOKIE" | "REDIS_URL" | "UPSTASH_REDIS_REST_URL" | "UPSTASH_REDIS_REST_TOKEN" | "TWITCH_CLIENT_SECRET" | "TWITCH_CLIENT_ID" | "ACCESS_TOKEN" | "REFRESH_TOKEN" | "TWITCH_SENDER_ID" | "TWITCH_DRY_RUN_CHANNEL_ID" | "DRY_RUN_MODE" | "POE1_TWITCH_ID" | "POE2_TWITCH_ID">> {}
}
